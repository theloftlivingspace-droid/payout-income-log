// ═══════════════════════════════════════════════════════════════
// Payout_Income_Log_v22.gs
// Changes from v21:
//   1. stylePayoutLog(): reapply OTA_BG + header + SCB sub/total สีให้ถูกหลัง sort/rebuild
//   2. fullRebuild(), rematch(), dailyEmailSync() เรียก stylePayoutLog() หลัง sort
//   3. fillMissingCiCoFromEmail() เรียกใน dailyEmailSync() ด้วย (เดิมขาด)
// ═══════════════════════════════════════════════════════════════
